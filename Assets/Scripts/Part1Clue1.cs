...
{
    public class Part1Clue1: MonoBehaviour
    {
        ...
        {
            string status = "";
            if (Initializer == null || EarthManager == null)
            {
                Debug.LogError("Initializer or EarthManager is null. Make sure to assign them in the inspector or initialize them before Update.");
                return;
            }
